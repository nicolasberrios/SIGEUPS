                ...
                <form
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @if($ups->foto_principal)

                                <div class="mb-3">

                                    <img
                                        src="{{ asset('storage/' . $ups->foto_principal) }}"
                        ...
                        <div>
                            ...
                            <select name="marca_id" class="w-full rounded border-gray-300">
                                ...
                                @foreach($marcas as $marca)
                                    ...
                                    <option
                                        value="{{ $marca->id }}"
                                        @selected(old('marca_id', $ups->modelo->marca_id) == $marca->id)>
                        ...
                        <div>
                            ...
                            <select name="modelo_id" class="w-full rounded border-gray-300">
                                ...
                                @foreach($modelos as $modelo)
                                    ...
                                    <option
                                        value="{{ $modelo->id }}"
                                        @selected(old('modelo_id', $ups->modelo_id) == $modelo->id)>
                            ...
                            <select name="propietario_id" class="w-full rounded border-gray-300">
                                ...
                                @foreach($propietarios as $propietario)
                                    ...
                                    <option
                                        ...
                                        @selected(old('propietario_id', $ups->propietario_id) == $propietario->id)>
                        ...
                        <div>
                            ...
                            <select name="estado_actual_id" class="w-full rounded border-gray-300">
                                ...
                                @foreach($estados as $estado)
                                    ...
                                    <option
                                        value="{{ $estado->id }}"
                                        @selected(old('estado_actual_id', $ups->estado_actual_id) == $estado->id)>
                        ...
                        <div>
                            ...
                            <select name="ubicacion_actual_id" class="w-full rounded border-gray-300">
                                ...
                                @foreach($ubicaciones as $ubicacion)
                                    ...
                                    <option
                                        value="{{ $ubicacion->id }}"
                                        @selected(old('ubicacion_actual_id', $ups->ubicacion_actual_id) == $ubicacion->id)>
